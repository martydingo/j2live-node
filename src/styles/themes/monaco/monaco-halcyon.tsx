...
export default function monaco_theme_halcyon() {
  monaco.editor.defineTheme("Halcyon", {
    inherit: false,
    base: "vs-dark",
    colors: {
      ...
      "editorIndentGuide.activeBackground": "#8695b777",
    ...
    rules: [
      ...
      {
        foreground: "#a2aabc",
        token: "string.unquoted.tag-string.nunjucks",
      },
      {
        foreground: "#a2aabc",
        token: "text.html.nunjucks",
      },
      {
        foreground: "#ffae57",
      ...
      {
        foreground: "#ffae57",
        token: "meta.function.block.start.handlebars",
      },
      {
        foreground: "#ffae57",
        token: "meta.function.inline.other",
      },
      {
        foreground: "#ffae57",
      ...
      {
        foreground: "#ffae57",
        token: "support.constant.mathematical-symbols",
      },
      {
        foreground: "#ffae57",
      ...
      {
        foreground: "#ffae57",
        token: "punctuation.separator.property",
      },
      {
        foreground: "#ffae57",
        token: "string.unquoted.filter-pipe",
      },
      {
        foreground: "#5ccfe6",
      ...
      {
        foreground: "#a2aabc",
        token: "meta.property-value.scss punctuation",
      },
      {
        foreground: "#a2aabc",
      ...
      {
        foreground: "#bae67e",
        token: "storage.type.attr.nunjucks",
      },
      {
        foreground: "#ffd580",
        token: "entity.name",
      ...
      {
        foreground: "#5ccfe6",
        token: "tag.decorator.js entity.name.tag",
      },
      {
        foreground: "#5ccfe6",
        token: "tag.decorator.js punctuation.definition.tag",
      },
      {
        fontStyle: "italic",
        foreground: "#ef6b73",
      ...
      {
        foreground: "#5ccfe6",
        token: "text.html.markdown markup.inline.raw.string.markdown",
      },
      {
        foreground: "#a2aabc",
